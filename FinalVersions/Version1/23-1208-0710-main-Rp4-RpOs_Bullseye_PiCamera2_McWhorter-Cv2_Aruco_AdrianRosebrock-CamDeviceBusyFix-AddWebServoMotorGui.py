...
###jwc y     servoAngle = 90
###jwc y     
###jwc y     sc.callback_servo_enable(int(servoId), trueMsg)
###jwc y     
###jwc y     angle = sc.msg(int(servoAngle))
###jwc y     sc.callback_servo_angle(int(servoId),angle)
###jwc y     ###jwc o print("arm", servoId, armAngle)
###jwc y     print("arm_Down", servoId, servoAngle)
###jwc y     
###jwc y     ###jwc o return ('id: ' + servoId + ' angle: ' + servoAngle)
###jwc y     return ('id: ' + str(servoId) + ' angle: ' + str(servoAngle))
###jwc y 
###jwc y     ###jwc o def move_servo(servoId, servoAngle):
###jwc y     ###jwc o 	sc.callback_servo_enable(int(servoId), trueMsg)
###jwc y     ###jwc o 	angle = sc.msg(int(servoAngle))
###jwc y     ###jwc o 	sc.callback_servo_angle(int(servoId),angle)
###jwc y     ###jwc o 	return ('id: ' + servoId + ' angle: ' + servoAngle)
...
###jwc ported from o: 
###jwc ported from o:     servoId = 0
###jwc ported from o:     servoAngle = 0
###jwc ported from o: 
###jwc ported from o:     sc.callback_servo_enable(int(servoId), trueMsg)
###jwc ported from o:     
###jwc ported from o:     angle = sc.msg(int(servoAngle))
###jwc ported from o:     sc.callback_servo_angle(int(servoId),angle)
###jwc ported from o:     ###jwc o print("arm", servoId, armAngle)
###jwc ported from o:     print("arm_Up", servoId, servoAngle)
###jwc ported from o:     
###jwc ported from o:     ###jwc o return ('id: ' + servoId + ' angle: ' + servoAngle)
###jwc ported from o:     return ('id: ' + str(servoId) + ' angle: ' + str(servoAngle))
###jwc ported from o: 
###jwc ported from o:     ###jwc o def move_servo(servoId, servoAngle):
###jwc ported from o:     ###jwc o 	sc.callback_servo_enable(int(servoId), trueMsg)
###jwc ported from o:     ###jwc o 	angle = sc.msg(int(servoAngle))
###jwc ported from o:     ###jwc o 	sc.callback_servo_angle(int(servoId),angle)
###jwc ported from o:     ###jwc o 	return ('id: ' + servoId + ' angle: ' + servoAngle)
